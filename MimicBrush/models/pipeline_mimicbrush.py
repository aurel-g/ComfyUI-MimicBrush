...
from .ReferenceNet_attention import ReferenceNetAttention
...
class MimicBrushPipeline(
    ...
    def prepare_latents(
        ...
        return outputs, source_image_latents
    ...
    def __call__(
        ...
        **kwargs,
        ...
        reference_control_reader = ReferenceNetAttention(self.unet, do_classifier_free_guidance=True, mode='read', fusion_blocks="midup", batch_size=1, is_image=True,)
        ...
        source_init_image = self.image_processor.preprocess(source_image, height=height, width=width)
        source_init_image = source_init_image.to(dtype=torch.float32)
        ...
        latents_outputs, source_image_latents = self.prepare_latents(
            ...
            latents,
            image=init_image,
            source_image = source_init_image,
        ...
        if num_channels_unet == 9:
            ...
            raise ValueError(
                f"The unet {self.unet.__class__} should have either 13 or 9 input channels, not {self.unet.config.in_channels}."
            )
